...
export default function ContactPage() {
  ...
  return (
    <MarketingShell>
      <MarketingHero
        badge="Contact"
        title={<>We are <span className="text-violet-300">here to help</span></>}
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-4">
          <ContactCard icon={<Mail size={16} className="text-violet-300" />} title="Email" body="support@qorixmarkets.com" />
          <ContactCard icon={<MessageCircle size={16} className="text-violet-300" />} title="Live chat" body="Available 24/7 from your dashboard." />
          <ContactCard icon={<Clock size={16} className="text-violet-300" />} title="Response time" body="Under 24 hours, usually under 2." />
          <ContactCard icon={<MapPin size={16} className="text-violet-300" />} title="Headquarters" body="Operating globally · Remote-first" />
        </div>
        ...
        >
          ...
          <Field label="Your name" required>
            <input
              ...
              className="w-full rounded-lg bg-black/30 border border-white/10 px-3 py-2.5 text-sm text-white outline-none focus:border-violet-400/40"
            />
          </Field>
          ...
          <Field label="Message" required>
            <textarea
              ...
              className="w-full rounded-lg bg-black/30 border border-white/10 px-3 py-2.5 text-sm text-white outline-none focus:border-violet-400/40 resize-none"
            />
          </Field>
          <button
            type="submit"
