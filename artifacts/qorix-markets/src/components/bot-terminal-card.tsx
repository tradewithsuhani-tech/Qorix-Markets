  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={expanded ? undefined : { height: TAPE_VISIBLE * 22 }}
      >
...
export function BotTerminalCard({
  ...
  const cardInner = (
    <>
      ...
      {/* Header — in fullscreen only the Charts tab keeps it; Quotes/Trade/History stay clean */}
      {(!isCardFs || activeTab === "charts") && (
