          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                {/* IMPORTANT: do NOT use `hidden` / `display:none` here —
                    iOS Safari + some Android browsers refuse to open the
                    file picker on a programmatic .click() of a fully
                    hidden input. We keep it in the layout but visually
